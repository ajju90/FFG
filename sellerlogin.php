...
$password=$_POST["password"];
  ...
  { 
    ...
    header('refresh:0; url=sellerlogin.php');
...
#icon {
  ...
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="POST"> 
      <h1 style= "font-family: 'Abril Fatface' , cursive;" >Seller Login </h1> 
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
    <p>Don't have an account ?<a href="sellersignup.php" class="text-info">Signup</a></p>
    </div>
