...
if($password==$cpassword){
  $sql="INSERT INTO `seller_info` (`sno`, `name`, `username`, `mobile`, `password`, `date`) 
...
<html lang="en">
  <head>  
    ...
    <style>
      body{  
                background-image: linear-gradient(rgba(0,0,0, 0.6),rgba(0,0,0, 0.6)), url('img/sellerregbg.jpg');
...
label{
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav m-auto my-2 my-lg-0 ">
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link " href="sellerlogin.php" style="color:white;">Login</a>
        </li>  
        </li>
          <li class="nav-item">
  ...
  { 
   ...
   ?>
   <div class="container">
    <h1 class="text-left text-white">Registration For Seller</h1>
