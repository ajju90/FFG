				...
				<div class="container-fluid bg-dark">
					<div class="row p-1" style="height: 100vh;">
					  ...
					  <div class="row bg-white ml-4 mt-3" style="border-radius: 00px; height: 40px; width: 100%;">
						...
						<div class="col-sm-10 mr-0 bg-white border-left p-0" style="height: 100vh; width: 100%;">     <main class="mt-100">
    <div class="col-sm-9">
...
$conn = mysqli_connect("localhost","root","","users");
            $query = "select * from ordrs where status='placed'";
    ...
    <tbody>
      ...
      <td>
		...
		<?php $path1 = "Orders.php?id=".$row['id'];?>
        <td><a   href="<?php echo $path1; ?>"  class="btn btn-success" >Delete</td>    
		<?php $path = "deliver.php?id=".$row['id'];?>
		<td><a   href="<?php echo $path; ?>"  class="btn btn-success" >Delivered</td>  
