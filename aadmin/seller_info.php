...
$query = "DELETE FROM `seller_info` WHERE sno='$id'";
$query_run = mysqli_query($link,$query);
if($query_run){ 
    echo "<script>alert('Deleted Succefully')</script>";   
    header('refresh:0; url=seller_info.php ');
}
 }
 ?>
				...
				<!-- <h6 style="color: black;">WELCOME </h6>-->
				  ...
				  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
				    <ul class="navbar-nav ms-auto">
				      <li class="nav-item">
						<a href="signin.php" style="text-decoration: none;" class="text-dark">𝐥𝐨𝐠𝐨𝐮𝐭</a>
				      </li>
				    </ul>
				  </div>
				</nav>
...
$conn = mysqli_connect("localhost","root","","users");
    ...
    <tbody>
      ...
      <td>
		...
		<td><a href="seller_info.php?id=<?= $row['sno']; ?>" class="btn btn-success ">Delete</a></td> 
      </tr>
      <?php 
      $a++;
       }           
